...
public interface ProductRepository extends JpaRepository<Product, Long> {
        ...
        @Query(value = """
                        SELECT  c.id AS c_id,
                                ...
                                p.name AS p_name,
                                p.price, p.currency,
                                p.in_sell_quantity AS p_quantity,
                                d.id AS d_id,
                                d.title AS d_title,
                                d.type AS d_type,
                                d.sales_percent_amount AS d_sales_percent_amount,
                                d.exp_date AS d_exp_date
                        FROM categories c
                        ...
                        WHERE p.id = :id
                        """, nativeQuery = true)
        Optional<ProductCategoryDiscountDTO> findProductWithDiscountAndCategoryById(@Param("id") Long id);
